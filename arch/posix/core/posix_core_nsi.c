...
/*
 * Interfacing between the POSIX arch and the CPU thread emulator
 */
...
{
	nct_swap_threads(te_state, next_allowed_thread_nbr, this_th_nbr);
}
...
{
	nct_abort_thread(te_state, thread_idx, self);
}
